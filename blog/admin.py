...
class RecipeAdmin(SummernoteModelAdmin):
    """
    Admin interface for the Recipe model with summernote integration. Define the list display, search fields, list filter, and prepopulated fields.
    """

    prepopulated_fields = {'slug': ('title',)}
    search_fields = ['title', 'content']
    list_filter = ('status', 'created_date', 'author')
    list_display = ('category', 'title', 'slug', 'status', 'created_date', 'author')
...
class CategoryAdmin(admin.ModelAdmin):
    """
    Admin interface for the Category model. Includes configuration for the list display and prepopulated slug field."""
...
class CarouselAdmin(admin.ModelAdmin):
    """
    Admin interface for the Carousel model. Includes configuration for the list display, search fields, and list filter."""
